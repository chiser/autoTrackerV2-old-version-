function [lastCentroid,centStamp,tOriDat]=optoMatchCentroids2ROIswithori(cenDat,oriDat,centers,speedThresh,distanceThresh,lastCentroid,centStamp,tElapsed)
...
%     size(centers)
    ...
    tOriDat(~isnan(j))=tempOriDat(j(~isnan(j)));
%     end
