...
% --- Executes during object creation, after setting all properties.
function togglebutton8_CreateFcn(~, ~, ~)
...
function togglebutton8_DeleteFcn(~, ~, ~)
% hObject    handle to togglebutton8 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object deletion, before destroying properties.
function togglebutton7_DeleteFcn(~, ~, ~)
% hObject    handle to togglebutton7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
set(handles.edit5,'String',fpath);
...
elseif handles.experiment == 1 
    ...
    switch handles.experiment
        ...
        case 5
            autoTrackerV2_led;
        case 6
            autoTrackerV2_optoYmaze;
        case 7
            autoTrackerV2_arenaOpto;
    end
end
...
% --- Executes during object deletion, before destroying properties.
function pushbutton3_DeleteFcn(~, ~, ~)
% hObject    handle to pushbutton3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function togglebutton9_CreateFcn(~, ~, ~)
% hObject    handle to togglebutton9 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object deletion, before destroying properties.
function togglebutton9_DeleteFcn(~, ~, ~)
% hObject    handle to togglebutton9 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
